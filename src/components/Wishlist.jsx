...
import { Button, ListGroup, Image, Row, Col, Container, Alert } from 'react-bootstrap';
...
const Wishlist = () => {
  ...
  // Load userId from localStorage or redirect if not found
  useEffect(() => {
            ...
            <ListGroup.Item key={item._id} className="py-3">
              <Row className="align-items-center">
                ...
                <Col xs={6}>
                  ...
                  <small className={item.product?.stock > 0 ? 'text-success' : 'text-danger'}>
